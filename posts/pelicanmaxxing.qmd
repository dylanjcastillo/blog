...
image: "images/cards/pelicanmaxxing.png"
date: "07/18/2026"
...
#| fig-cap: "Mean animal rating by animal, all models pooled."
#| echo: false
...
3. No pelican-bicycle cell effect (the *extra* boost on the specific combination, on top of the lab's pelican and bicycle effects) clears p < 0.05. The largest positive is _GLM-5.2_ at +0.35 (p=0.12), which is the one I mentioned earlier. It's the closest thing to a signal in this experiment, but still within chance.
...
2. **SVGmaxxing.** A lab that optimized SVG generation *as a whole* (or a subset such as animals on vehicles) rises on every cell at once and looks identical to a lab that's just good. Some labs, such as Google/DeepMind, [openly](https://x.com/JeffDean/status/2024525132266688757) do this. This experiment can't detect that.
