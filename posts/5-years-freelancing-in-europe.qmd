---
title: "5 Years of Freelancing: same work, better pay, and a ceiling"
date: 2026-04-25
...
Five years ago, freelancing looked like arbitrage: same work, better pay, and barely any lifestyle change. So I left my full-time job in the middle of the pandemic and gave it a shot.

It worked. Since then, I've worked with scrappy startups and global organizations. I moved from classic data science and ML into building AI products. Freelancing gave me more freedom, more variety, and more time to work on the things I care about.

But it also trapped me by rewarding me for staying broad. I chased interesting projects, optimized for pay, and avoided going too deep into any topic. Now, I’ve hit a ceiling I can’t seem to push past.

This is a recap of how I got in, what freelancing gave me, how the business actually works, and where I think I went wrong.
...
In practice, I barely got any help from the platform. But they did suggest a few introductions, and one of them stuck with me: a freelance data scientist.
...
I set up a bot that messaged pretty much everyone involved in data science in Europe: managers, recruiters, and a few confused interns. Most people ignored me. A few wrote back to ask whether what I was doing was even legal. Most recruiters dismissed me because I had no prior freelancing experience to point to.
...
Instead, I decided to start a blog, share useful projects and tutorials on LinkedIn, and apply to contracting opportunities in the hope that something would pan out. For a while, nothing did.
...
The second thing it gave me is freedom and comfort. I work fully remotely from home and can often set my own schedule. I stay healthy: I hit the gym four days a week and walk 12,000 steps every day with my walking pad while I work. I also avoid most corporate theater: 360 reviews or recurring "how are you feeling?" meetings. Clients care that I deliver value.

The third is variety. On one project I'm acting as a PM, scoping a product and figuring out what should be built. On another I'm a data scientist, planning and analyzing experiments. On another I'm an AI engineer, shipping features for workflows or agents. I love the intellectual range of things I get to do.
...
How much you make heavily depends on where your clients are. In Europe, Northern European clients usually pay much better than Southern European ones. So I rarely work with local clients. 
...
Pricing model matters too. I've also experimented with switching from day rates to deliverable-based pricing on certain projects, and I usually prefer it. When the contract is structured around an outcome rather than time, my effective rate goes up, and my incentives and the client's incentives line up. The client doesn't care much about how many hours I'm putting in. They care about what they get.
...
That is the ceiling I’ve hit. I can still find work. but I don’t yet have a strong enough answer to “Why you?” to go above the rates I charge now. At higher rates, clients want more than competence. They want reputation, expertise, and trust. I haven’t found the right way to position myself for that yet.

## What I'd do differently

With hindsight, these are the things I’d do differently if I were starting over:

1. **Don’t start with cold outreach.** The boring answer is the right answer: use your network. And by that, I don't mean LinkedIn randos. Reach out to former colleagues, old bosses, past clients, and people who already know your work. That's the simplest way to get started. But most people avoid it because it's awkward.  
...
We don't want to be just another AI development agency™. That's pretty common trope, but we have a few areas where we've built expertise over the years, and I hope we can position ourselves around them. But that will take time to get right. 
