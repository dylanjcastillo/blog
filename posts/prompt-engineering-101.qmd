---
title: "Persuading LLMs (or how to write good prompts)"
date: 2025-06-26
...
These messages are passed through a [chat template](https://huggingface.co/docs/transformers/en/chat_templating) and converted into a single string that is sent to the model to generate a response. 
...
After you make the request, the model will respond with an *assistant* message that contains the model's reply^[I removed the thinking tokens for brevity.]. 
