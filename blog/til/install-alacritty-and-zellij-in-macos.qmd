...
- Installed [Copilot](https://github.com/github/copilot.vim) and [CopilotChat](https://github.com/CopilotC-Nvim/CopilotChat.nvim).
- Installed [One Dark](https://github.com/navarasu/onedark.nvim) color scheme.

The Copilot plugins are available in `:LazyExtras`, so it's very easy to install them. Run `:LazyExtras` and select the plugins, and then install them with {{<kbd I >}}.
...
I learned about a few useful tools that I've now included in my daily workflow:
...
[lazygit](https://github.com/jesseduffield/lazygit): A simple terminal UI for `git`. I've found it better than GitHub Desktop when doing complex operations.

Here's a screenshot of the main screen:

![lazygit](images/lazygit-screenshot.png)

[eza](https://github.com/eza-community/eza): An improved version of `ls`. I also added a couple of aliases from Omakub: 
...
That's all. There's no real conclusion except that I've likely wasted 4 hours of my life trying to get this setup working.
