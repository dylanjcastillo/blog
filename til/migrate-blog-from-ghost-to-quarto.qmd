...
First, you must download a copy of your.

Adjust this URL and run it in your browser: `<YOUR_BLOG_URL>/ghost/#/settings/migration`.

![Exporting my blog](images/ghost-export.png)

Once you're in the export page, click on `Export`, and click on `Export JSON`.

This will generate a JSON file with all the posts and pages in your blog. You'll need to process it to convert your posts to Quarto posts.

I used this small Python script that did the heavy lifting for me:
...
I also added a custom `custom.scss` file to modify some Bootstrap styles.
