...
Kamal is a simpler alternative to [Kubernetes](https://kubernetes.io/) that you can use to deploy containerized apps to a [VPS](https://en.wikipedia.org/wiki/Virtual_private_server). I've used to deploy many apps based on FastAPI, Django, or Express.
