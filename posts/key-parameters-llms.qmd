...
image: "images/cards/key-parameters-llms.png"
date: 2025-06-29
date-modified: "2025-06-29"
description-meta: "What are the most commonly used parameters when working with LLMs?"
categories:
  - llm
  - openai
  - anthropic
...
:::{.callout-note}
Each provider has a slightly different name for the same parameter, but the concept is the same. You'll have to check the documentation of the provider you're using to see the exact name of the parameter.
:::
...
Logprobs are the logarithmic probabilities of the tokens. They are defined as:
