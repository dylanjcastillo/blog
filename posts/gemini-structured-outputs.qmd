...
In this article, I'll share the results of running the same benchmarks for _Gemini 1.5 Flash_ and a few interesting things I learned about the Gemini API along the way.
